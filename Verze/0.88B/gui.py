...
# Nastavení cwd na tuto složku - potřeba pro VS Code a asi i některé linux/unixy, protože to SAMI NEUDĚLŮAJÍ (udělají, jen přístup k souborům nefunguje)
...
#List: problems-lastPRproblems:, setup, runCheck
...
if runCheck:
    print("runCheck not supported yet")
