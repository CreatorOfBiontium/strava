...
1. Errory a varování:
    ...
    Error11: Couldn't order food: o: {odpoved.status_code} o2: {odpoved2.status_code}
...
1.1. Troubleshooting:
    ...
    Error11: Objed je už pravděpodobně zabraný, zkotrolujte stav a případně mi napište
...
11. Verze:
    ...
    - Poslední update tohoto odstavce: 15:35 14.05.2024
    - Dostupné verze:
        0.9 - veřejná verze; 14.05.2024; optimalizováno pro python 3.11.3; vytvořeno ve VS Code
            - ChangeLog:
            ...
            - Poznámky: Restartování možná stále nefunguje, no, jak kdy, takže kód restartujte sami.

        0.89b - veřejná verze; 04.04.2024; optimalizováno pro python 3.11.3; vytvořeno ve VS Code
            - ChangeLog:
                - Odstranení otravného upozornění při check na startu
                - Oprava startováání vlákna 1 a freeze
                - Přidá popisu na začátku kódu
                - Menší úpravy v kódě

            - Poznámky: Netuším co dělat s tím přepínáním na Linuxy, ale nevím jestli to nefunguje na všech Linuxech, zkoušel jsem to jen na dvou
